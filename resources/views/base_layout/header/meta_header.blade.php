<meta charset="utf-8" />
        ...
        <link href="{{asset('control/assets/global/plugins/select2/css/select2.min.css')}}" rel="stylesheet" type="text/css" />
        <link href="{{asset('control/assets/global/plugins/select2/css/select2-bootstrap.min.css')}}" rel="stylesheet" type="text/css" />
        @if(app()->getLocale() == 'ar')
        ...
        <link href="{{asset('control/assets/layouts/layout/css/themes/darkblue.min.css')}}" rel="stylesheet" type="text/css" id="style_color" />
            <link rel="stylesheet" href="{{ asset('datatableAdmin/plugins/datatables/dataTables.bootstrap.css') }}">
        <link href="{{asset('control/assets/layouts/layout/css/custom.min.css')}}" rel="stylesheet" type="text/css" />
        @endif
        <!-- END THEME LAYOUT STYLES -->
     <link rel="shortcut icon" href="{{asset('control/logo.png')}}" /> 
